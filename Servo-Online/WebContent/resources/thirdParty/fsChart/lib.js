...
var tmpChart = new FusionCharts("Spline.swf", "tmpChartId", "560", "400", "0");
...
if (typeof jQuery != 'undefined') { 
	...
	$(document).ready(function()
	{
		...
		{
			$("#toggleView").remove();
			$("div.qua-button-holder").css({"width":"290px" });
		}
...
function swapRenderer (name) {
	...
	for(var i in FusionCharts.items)
	{
		...
		fcProperties["dataSource"] = FusionCharts.items[i].getXMLData(false);
		
		console.log(fcProperties["dataSource"]);
